...
const API_URL = {
    ...
    'CONTROLLER_SESSION_DELETE': SERVER.HOST + SERVER.API_CONTROLLERS + '/SessionDeleteController.php',
    ...
    'CONTROLLER_INVITACION_PUT': SERVER.HOST + SERVER.API_CONTROLLERS + '/InvitacionPutController.php',
